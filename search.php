...
include 'display-menu.php';
    ...
    $sql = "SELECT * FROM producten WHERE productnaam LIKE :search_query OR beschrijving  LIKE :search_query OR id LIKE :search_query ORDER BY (productnaam LIKE :search_query_starts) DESC";
